...
urlpatterns = [
    ...
    path("contacts/<int:pk>/export/", views.contact_export, name="contact-export"),
    ...
    path("companies/merge/", views.company_merge, name="company-merge"),
    path("settings/duplicates/", views.duplicate_companies, name="duplicates"),
